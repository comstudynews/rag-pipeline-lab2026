...
Vector Store를 Retriever로 감싸고 Top-K 검색 결과를 직접 확인합니다.

- 교재: [해당 장 바로가기](https://app.notion.com/p/3de91bd5a9ac81cdab0dcfe6ae2f4ef8)
- `practice/`: 현재 Step을 직접 완성하는 연습용
- `complete/`: 교재 기준 완성 코드

## 실행

VS Code에서 **File → Open Folder...**를 선택하고 `step06_retriever/practice` 폴더를 엽니다. 완성 코드 확인이 필요할 때만 같은 Step의 `complete` 폴더를 엽니다.
