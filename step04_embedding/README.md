...
텍스트를 벡터로 변환하고 Cosine Similarity와 Provider 교체 개념을 이해합니다.

- 교재: [해당 장 바로가기](https://app.notion.com/p/3de91bd5a9ac814397a9e510d3d895f5)
...
```bash
uv run --locked python src/04_embedding.py
```
