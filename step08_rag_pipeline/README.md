# Step 08. RAG Pipeline 완성

rag_core.py와 LCEL을 사용해 전체 RAG Pipeline을 하나로 연결합니다.

- 교재: [해당 장 바로가기](https://app.notion.com/p/3de91bd5a9ac819394e4de18a8f2c65f)
- `practice/`: 현재 Step을 직접 완성하는 연습용
- `complete/`: 교재 기준 완성 코드

## 실행

VS Code에서 **File → Open Folder...**를 선택하고 `step08_rag_pipeline/practice` 폴더를 엽니다. 완성 코드 확인이 필요할 때만 같은 Step의 `complete` 폴더를 엽니다.
